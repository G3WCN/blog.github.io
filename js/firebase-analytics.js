	...
	try { !
		function() {
			...
			function E(e, t, n) {
				...
				e = Math.round(_ * n * (Math.random() - .5) * 2);
			...
			D(x, "_index", IDBIndex, ["get", "getKey", "getAll", "getAllKeys", "count"]),
			...
			D(j, "_store", IDBObjectStore, ["put", "add", "delete", "clear", "get", "getAll", "getKey", "getAllKeys", "count"]),
			...
			["openCursor", "openKeyCursor"].forEach(function(i) { [j, x].forEach(function(e) {
			...
			function X(e, t) {
				t = t.refreshToken,
				e = Y(e);
				return e.append("Authorization", q + " " + t),
				e
			}
			function Z(n) {
				return p(this, void 0, void 0,
			...
			function se(e, t) {
				var n, r, i = oe.get(e);
				if (i) try {
					for (var o = s(i), a = o.next(); ! a.done; a = o.next())(0, a.value)(t)
				} catch(e) {
					n = {
						error: e
					}
			...
			var fe, de, pe = "firebase-installations-database",
			he = 1,
			ve = "firebase-installations-store",
			ge = null;
			function me() {
				var e, t, n;
				return ge || (e = he, t = function(e) {
					0 === e.oldVersion && e.createObjectStore(ve)
				},
				(n = (e = O(indexedDB, "open", [pe, e])).request) && (n.onupgradeneeded = function(e) {
			...
			function be(r) {
				...
				function() {
					...
					function(e) {
						...
						case 1:
							return n = e.sent(),
							[4, (n = n.transaction(ve, "readwrite")).objectStore(ve).delete(t)];
						case 2:
							return e.sent(),
							[4, n.complete];
						case 3:
			...
			function Se(i, o) {
				...
				function() {
					...
					function(e) {
						switch (e.label) {
						case 0:
							return [4, we(i.appConfig,
							function(e) {
								if (!Oe(e)) throw U.create("not-registered");
								var t, n = e.authToken;
								if (o || 2 !== (t = n).requestStatus ||
								function(e) {
									var t = Date.now();
			...
			function Ce(e) {
				...
				function(e) {
					if (!Oe(e)) throw U.create("not-registered");
					var t = e.authToken;
					return 1 === (t = t).requestStatus && t.requestTime + B < Date.now() ? c(c({},
					e), {
						authToken: {
							requestStatus: 0
						}
			...
			function Pe(e, r) {
				...
				return function(e, t) {
					ce();
					var n = ie(e); (e = oe.get(n)) || (e = new Set, oe.set(n, e)),
					e.add(t)
				} (i, r),
				function() {
					var e, t, n;
					t = r,
					n = ie(e = i),
					(e = oe.get(n)) && (e.delete(t), 0 === e.size && oe.delete(n), le())
				}
			}
			function Ae(e) {
		...
		default).INTERNAL.registerComponent(new T("installations",
			function(e) {
			...
			Object.defineProperty(Fe.prototype, "logHandler", {
				...
				this._userLogHandler && this._userLogHandler.apply(this, a([this, de.DEBUG], e)),
				this._logHandler.apply(this, a([this, de.DEBUG], e))
			},
			Fe.prototype.log = function() {
				for (var e = [], t = 0; t < arguments.length; t++) e[t] = arguments[t];
				this._userLogHandler && this._userLogHandler.apply(this, a([this, de.VERBOSE], e)),
				this._logHandler.apply(this, a([this, de.VERBOSE], e))
			},
			Fe.prototype.info = function() {
				for (var e = [], t = 0; t < arguments.length; t++) e[t] = arguments[t];
				this._userLogHandler && this._userLogHandler.apply(this, a([this, de.INFO], e)),
				this._logHandler.apply(this, a([this, de.INFO], e))
			},
			Fe.prototype.warn = function() {
				for (var e = [], t = 0; t < arguments.length; t++) e[t] = arguments[t];
				this._userLogHandler && this._userLogHandler.apply(this, a([this, de.WARN], e)),
				this._logHandler.apply(this, a([this, de.WARN], e))
			},
			Fe.prototype.error = function() {
				for (var e = [], t = 0; t < arguments.length; t++) e[t] = arguments[t];
				this._userLogHandler && this._userLogHandler.apply(this, a([this, de.ERROR], e)),
			...
			var Me, Be, He = "firebase_id",
			qe = "origin",
			Ve = 6e4,
			Ge = "https://firebase.googleapis.com/v1alpha/projects/-/apps/{app-id}/webConfig",
			Ke = "https://www.googletagmanager.com/gtag/js"; (K = Me = Me || {}).EVENT = "event",
			K.SET = "set",
			K.CONFIG = "config",
									...
									function() {
										...
										function(e) {
											...
											case 1:
												...
												e.label = 2;
											case 2:
												return 0 === n.length && (n = Object.values(c)),
												[4, Promise.all(n)];
											case 3:
												return e.sent(),
												u(Me.EVENT, f, d || {}),
			...
			function Xe(o) {
				...
				function() {
					...
					function(e) {
						...
						case 3:
							return i = e.sent(),
							null !== (a = i.error) && void 0 !== a && a.message && (r = i.error.message),
							[3, 5];
						case 4:
							return e.sent(),
							[3, 5];
							...
							function() {
								...
								function(e) {
									...
									case 2:
										...
										[3, 4];
									case 3:
										if (i = e.sent(), n) return Ue.warn("Timed out fetching this Firebase app's measurement ID from the server. Falling back to the measurement ID " + n + ' provided in the "measurementId" field in the local Firebase config. [' + i.message + "]"),
										[2, {
											appId: t,
											measurementId: n
										}];
									...
									case 5:
										...
										[2, o];
									case 6:
										if (et(r = e.sent())) return i = 503 === Number(r.customData.httpStatus) ? E(f, c.intervalMillis, ze) : E(f, c.intervalMillis),
										o = {
											throttleEndTimeMillis: Date.now() + i,
											backoffCount: f + 1
										},
										c.setThrottleMetadata(t, o),
										Ue.debug("Calling attemptFetch again in " + i + " millis"),
										[2, a(s, o, u, c)];
										if (c.deleteThrottleMetadata(t), n) return Ue.warn("Failed to fetch this Firebase app's measurement ID from the server. Falling back to the measurement ID " + n + ' provided in the "measurementId" field in the local Firebase config. [' + r.message + "]"),
										[2, {
											appId: t,
											measurementId: n
										}];
					...
					function(e) {
						...
						case 0:
							return (i = Ze(s)).then(function(e) {
								...
								s.options.measurementId && e.measurementId !== s.options.measurementId && Ue.warn("The measurement ID in the local Firebase config (" + s.options.measurementId + ") does not match the measurement ID fetched from the server (" + e.measurementId + "). To ensure analytics events are always sent to the correct Analytics property, update the measurement ID field in the local config or remove it from the local config.")
							}).
							catch(function(e) {
								return Ue.error(e)
							}),
							...
							o = function() {
								...
								function() {
									...
									function(e) {
										...
										case 3:
											return t = e.sent(),
											Ue.warn($e.create("indexeddb-unavailable", {
												errorInfo: t
											}).message),
											[2, !1];
										case 4:
						...
						case 1:
							...
							} () || (t = d, n = i.measurementId, (r = document.createElement("script")).src = Ke + "?l=" + t + "&id=" + n, r.async = !0, document.head.appendChild(r)),
							f("js", new Date),
							(a = {})[qe] = "firebase",
							a.update = !0,
							a = a,
			...
			function pt(e, t) {
				...
				0 < i.length && (i = i.map(function(e, t) {
					return "(" + (t + 1) + ") " + e
				...
				if (null != at[u]) throw $e.create("already-exists", {
					id: u
				});
				return ft || (a = ct, s = [], Array.isArray(window[a]) ? s = window[a] : window[a] = s, n = at, r = st, i = ut, o = ct, a = lt, s = function() {
					for (var e = [], t = 0; t < arguments.length; t++) e[t] = arguments[t];
					window[o].push(arguments)
				},
				window[a] && "function" == typeof window[a] && (s = window[a]), window[a] = We(s, n, r, i), a = {
					gtagCore: s,
					wrappedGtag: window[a]
				},
				ot = a.wrappedGtag, it = a.gtagCore, ft = !0),
							...
							function() {
								...
								function(e) {
									...
									case 0:
										...
										for (t = {},
										n = 0, r = Object.keys(u); n < r.length; n++) i = r[n],
		...
		default).INTERNAL.registerComponent(new T(vt,
			function(e) {
			...
			ht.INTERNAL.registerComponent(new T("analytics-internal",
			function(e) {
				try {
					return {
