...
function() {
	...
	var o = (t.prototype.wrapCallback = function(n) {
		...
		return function(e, t) {
			...
			"function" == typeof n && (r.promise.
			catch(function() {}), 1 === n.length ? n(e) : n(e, t))
		}
	},
	t);
	function t() {
		...
		function() {
			...
			function(e) {
				...
				case 0:
					...
					[4, Promise.all(a(a([], p(t.filter(function(e) {
	...
	C.prototype.initialize = function(e) {
		...
		return this.invokeOnInitCallbacks(o, i),
		o
	},
	...
	C.prototype.invokeOnInitCallbacks = function(e, t) {
		var n, r;
		try {
			for (var i = u(this.onInitCallbacks), o = i.next(); ! o.done; o = i.next()) {
				var a = o.value;
				try {
					a(e, t)
				} catch(e) {}
	...
	var L = (S.prototype.addComponent = function(e) {
	...
	function J(a) {
		...
		l = {
			...
			initializeApp: function(e, t) {
				...
				if (m(s, t)) throw B.create("duplicate-app", {
					appName: t
				});
				n = new a(e, n, l);
				return s[t] = n
		...
		function u(e) {
			if (!m(s, e = e || M)) throw B.create("no-app", {
				appName: e
			});
			return s[e]
		}
		function o(n) {
			var e, r = n.name;
			if (c.has(r)) return W.debug("There were multiple attempts to register component " + r + "."),
			"PUBLIC" === n.type ? l[r] : null;
			c.set(r, n),
			"PUBLIC" === n.type && (e = function(e) {
	...
	var q, Q, ee = H; (q = ee).INTERNAL.registerComponent(new E("platform-logger",
	function(e) {
		return new K(e)
	},
	"PRIVATE")),
	q.registerVersion(V, "0.6.21", Q),
	q.registerVersion("fire-js", "");
	return ee.registerVersion("firebase", "8.5.0", "app"),
	ee
});
